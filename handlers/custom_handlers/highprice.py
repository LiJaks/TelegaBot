...
from handlers import central_logic

# condition_high = "PRICE_HIGHEST_FIRST" # критерий поиска отелей от высокой цены
...
#         with bot.retrieve_data(message.from_user.id, message.chat.id) as data:
#             data['check_photo'] = message.text
#         print('CH', condition_high)
#         final_response(message, condition)
#     else:
